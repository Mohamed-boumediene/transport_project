   ...
   $i=0;
    ...
    <select  name="<?php echo $row['idtiq'];?>"   id="<?php echo $row['idtiq'];?>"  class="form-control">
       ...
       <td>
         ...
         <button type="button" onClick="sub('<?php echo $row['idtiq'];?>')" class="btn  btn-block "  data-toggle="modal"  data-target="#mywindow">submit</button>
...
<?php
    ...
    <select  name="ch"   id="ch"  class="form-control">
       ...
       <option value="essa">essa </option>
        ...
        <button type="button" onClick="chaff('ch','<?php echo $ligne; ?>','<?php echo $date; ?>');" class="btn   btn-block"data-toggle="modal"  data-target="#mywindow">submit</button>
   ...
   <?Php
	...
	echo'<a type="button" class="  btn   btn-block  btn-danger"  href="tablevoyages.php" >return</a> </div>';
	
	
	}

if($result->num_rows){
	echo '<h1> table voyages</h1>';
...
function ()
{
$('#load_tweets').load('l.php?date=<?php echo $date; ?>&ligne=<?php echo $ligne; ?>').fadeIn("slow");
