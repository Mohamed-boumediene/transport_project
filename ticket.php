...
$result1=("insert into bagage  (poids,bagprix,clientmat,depart,arriver)values ('$kg','$prixbag','$cartedandite','$depart','$arriver')");
$result3=("insert into voyages (numchaise,datevoya,ligne,prix,clients)  values('$chaise','$date','$ligne','$prixvoya','$cartedandite')");


if ($conxn->multi_query($result0)) {
    echo  good;
}else{
	
	echo "Multi query failed: (" . $conxn->errno . ") " . $conxn->error;
	
	}
if ($conxn->multi_query($result1)) {
    echo  good;
}else{
...
<h1 >Réçue transfert d'argents</h1 class="ty  col-md-offset-10"><p> <h3><?php echo "ID TICKET : ".$idtiq;?></h3></p>
...
<div class="row">
  <div class=" form-group col-md-2">
   ...
   <label class=" control-label"><h4>choose ligne:</h4></label>
   </div>
...
<!-- <br>-->
 ...
 <div class=" form-group col-md-3">
  ...
  <button type="button"  class="  btn   btn-default input-md btn"  onclick="p('pr');">print ticket</button>
