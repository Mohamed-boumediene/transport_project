...
<script>
   ...
   function FormValidation(){
	...
	if(l.value !='select ligne:'){
		...
		if(l.value !='select ligne:' && dat.value !='' ){
		return true;
...
<form action="affichevoyagesp.php" method="get"  onsubmit="return FormValidation();"  >
     <h1>voyages</h1>
    ...
    <select  id="ligne" name="ligne"   class="form-control">
       ...
       <option value="nouakchott-tnbgda">nouakchott-ndb </option>
